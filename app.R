...
ui <- fluidPage( theme = shinytheme("cerulean"),
                 ...
                 tabsetPanel(
                   tabPanel("Sissejuhatus",
                            sidebarPanel( img(src = "pilt.jpg", height = 500, width = 400)),
                   ...
                   tabPanel("Andmed",
                            ...
                            sidebarLayout(
                              sidebarPanel(tags$h4("Tunnused:"),br(), 
                                           tags$b("2FI1204")," - kulu",br(),
                                           tags$b("2PI1211")," - r6hk",br(),
                                           tags$b("2FIC1201")," - kulu",br(),
                                           tags$b("2K-167A")," - staatus",br(),
                                           tags$b("2K-167")," - staatus",br(),
                                           tags$b("2K-169")," - staatus",br(),
                                           tags$b("2PI1301")," -r6hk",br(),
                                           tags$b("2PI1212")," - r6hk",br(),
                                           tags$b("2K175")," - staatus",br(),
                                           tags$b("2FI1203")," - kulu",br(),
                                           tags$b("2LIAS3250")," - tase",br(),
...
server <- function(input, output) {
  ...
  output$text3 <- renderText({"Projektis oli kasutatud andmestik, mis on parit otse ettevotest ja andurite naitudest. GitHub: https://github.com/gvolodin/RShinyProject Kuna GitHub ei v6imalda laadida failid mis on suurem kui 25MB kaustas 'data' on puudu 2 esimest andmestiku "})
